...
```php
Literal::new(Demo::class, 10, foo: 20);
// generates: new Demo(10, foo: 20)
```

Calling a method or function is generated by the `call` method:

```php
Literal::call('rand', 10, 20);
// generates: rand(10, 20)
```

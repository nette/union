...
use function array_filter, array_key_exists, array_map, array_merge, array_values, array_walk_recursive, class_exists, ctype_digit, explode, gettype, implode, in_array, interface_exists, is_a, is_array, is_int, is_scalar, is_string, iterator_to_array, preg_match, preg_replace, sprintf, str_contains, str_replace, str_starts_with, strlen, substr;

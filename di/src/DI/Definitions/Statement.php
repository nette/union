...
use function array_keys, class_exists, count, explode, function_exists, in_array, interface_exists, is_array, is_string, preg_match, sprintf, str_contains, str_ends_with, str_starts_with, substr;

...
final class Helpers
{
	 ...
	 * @throws Nette\InvalidArgumentException
	 */
	private static function expandString(string $string, array $params, ?array $recursive, bool $onlyString = false): mixed
	{
	...
	private static function expandParameter(string $parameter, array $params, ?array $recursive, bool $onlyString): mixed
	{
		$val = $params;
		$path = [];

...
test('date: min & max validator', function () {
	...
	Assert::same('<input type="date" name="date" min="2020-01-01" max="2040-01-01" id="frm-date" data-nette-rules=\'[{"op":":min","msg":"Please enter a value greater than or equal to 2020-01-01.","arg":"2020-01-01"},{"op":":max","msg":"Please enter a value less than or equal to 2040-01-01.","arg":"2040-01-01"}]\'>', (string) $input->getControl());
});
...
test('date: range validator', function () {
	...
	Assert::same('<input type="date" name="date" min="2020-01-01" max="2040-01-01" id="frm-date" data-nette-rules=\'[{"op":":range","msg":"Please enter a value between 2020-01-01 and 2040-01-01.","arg":["2020-01-01","2040-01-01"]}]\'>', (string) $input->getControl());
});
...
test('time: range validator', function () {
	...
	Assert::same('<input type="time" name="time" min="11:22" max="22:33" id="frm-time" data-nette-rules=\'[{"op":":range","msg":"Please enter a value between 11:22 and 22:33.","arg":["11:22","22:33"]}]\'>', (string) $input->getControl());
});
...
test('time with seconds: range validator', function () {
	...
	Assert::same('<input type="time" name="time" step="1" min="11:22:33" max="22:33:44" id="frm-time" data-nette-rules=\'[{"op":":range","msg":"Please enter a value between 11:22:33 and 22:33:44.","arg":["11:22:33","22:33:44"]}]\'>', (string) $input->getControl());
});
...
test('date-time with value', function () {
	...
	Assert::same('<input type="datetime-local" name="time" id="frm-time" value="2023-10-22T07:05">', (string) $input->getControl());
});
